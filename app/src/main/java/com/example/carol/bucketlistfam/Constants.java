...
public class Constants {
    public static final String BRITE_CONSUMER_KEY=BuildConfig.BRITE_CONSUMER_KEY;
    public static final String BRITE_CONSUMER_SECRET = BuildConfig.BRITE_CONSUMER_SECRET;
